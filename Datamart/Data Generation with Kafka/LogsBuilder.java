...
public class LogsBuilder{
	...
	{	
			...
			try {
                ...
                FileWriter writer = new FileWriter("C:/Workbench/OnMartData/PurchasesLog.csv",true);  
			...
			try {
                ...
                FileWriter writer = new FileWriter("C:/Workbench/OnMartData/WarehouseDistributionCenterLog.csv",true);  
                List<String> record = new ArrayList<>();
